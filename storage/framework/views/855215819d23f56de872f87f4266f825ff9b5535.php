        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <h2>El número elegido es: <?php echo e($numero); ?></h2>
                        </div>
                    </div>
                    <br />
...
<?php /**PATH C:\xampp\htdocs\ProyectosMios\prueba-adivina-numero-gdoce\resources\views/result.blade.php ENDPATH**/ ?>